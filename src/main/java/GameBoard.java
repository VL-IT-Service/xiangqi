public class GameBoard {
    ...
    private void checkLegalEndPosition (moveStartRow, moveStartCol, moveEndRow, moveEndCol) throws MoveNotLegalException {
        // General's direct view to enemy general
	GameToken general = getGeneral(fields[moveStrtRow][moveStartCol].getOwner());
	...
	int testRow = getRow(general) + directionToEnemy;
        ...
        if (nextTokenInRow != null && nextTokenInRow.getClass() instanceof General){
